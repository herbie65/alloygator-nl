      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-gray-900">Accessoires</li>
          </ol>
        </nav>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-green-600">
                    €{isDealer ? (product.price * 0.8).toFixed(2) : product.price.toFixed(2)}
                    {isDealer && <span className="text-sm text-gray-500 ml-2">(20% korting)</span>}
                  </div>
                  <button
        ...
        {products.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Geen accessoires gevonden.</p>
